        ...
        <div>
          ...
          <div className='flex flex-row md:flex-col items-center justify-center gap-4 md:gap-2'>
            <button
              ...
              className='text-sm md:text-sm bg-background-purple rounded-full py-[6px] px-3.5 md:px-5 hover:bg-background-purple/90 border border-border-dark'>
              Set Up a Time
            </button>
            <button
              aria-label='learn more'
              className='text-sm md:text-sm bg-background-gray-950 rounded-full py-[6px] px-3.5 md:px-5 hover:bg-background-gray-900 border border-border-dark'>
              Learn More
            </button>
          </div>
        </div>
